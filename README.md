...
```bash
python -m PyInstaller -y --name "Verilog Studio" --windowed --noconsole --icon=NONE main.py
```
...
6. **Synthesize:** Hit `F6` or click the Link button to synthesize the active file. The high-res schematic PNG will automatically open when complete!
